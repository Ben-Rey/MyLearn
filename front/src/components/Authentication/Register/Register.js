  ...
  render() {
    return (
      <Form success>
        ...
        <Button content="Register" color="grey" onClick={this.handleSubmit} />
        <Button content="Reset" color="red" onClick={this.resetForm} />
        ...
        {this.state.successRegister ? (
          <Message success style={{ width: "180px", marginLeft: "14px" }}>
            <Message.Header style={{ color: "#2c662d", textAlign: "left" }}>
              Success
            </Message.Header>
            <p
              style={{
