...
export const addVideo = video => {
  ...
  return (dispatch, getState) => {
    axios
      .post("http://163.172.83.78:80/service/video/add", {
        user: localStorage.user,
        videoUrl: video.Url,
        title: video.title,
...
export const deleteVideo = id => {
  return (dispatch, getState) => {
    axios
      .delete("http://163.172.83.78:80/service/video/delete", {
        params: {
          user: localStorage.user,
          _id: id
        }
...
export const getTopicList = () => {
  return (dispatch, getState) => {
    ...
    // });
    axios
      .get("http://163.172.83.78:80/service/videoTopic/get", {
        params: {
          user: localStorage.user
        }
      })
...
export const addTopic = topic => {
  return (dispatch, getState) => {
    axios
      .post("http://163.172.83.78:80/service/videoTopic/add", {
        params: {
          user: localStorage.user,
          topic: topic
        }
