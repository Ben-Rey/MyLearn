...
import Background from "../../../assets/DashBoard/DashBoardAlbumBack.jpg";

const FormulaireAlbum = props => {
    ...
    <div className={classes.globalContainer} style={sectionStyle} id={props.id}>
      ...
      >
        <Form.Group widths="equal">
          <Form.Input fluid label="Album" placeholder="First name" />
...
export default FormulaireAlbum;
