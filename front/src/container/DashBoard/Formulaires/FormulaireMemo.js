...
import Background from "../../../assets/DashBoard/DashBoardMemoBack.jpg";

const FormulaireMemo = props => {
    ...
    <div className={classes.globalContainer} style={sectionStyle} id={props.id}>
      ...
      >
        <Form.Group widths="equal">
          <Form.Input fluid label="Memo" placeholder="First name" />
